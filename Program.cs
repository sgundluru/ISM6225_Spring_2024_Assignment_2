    ...
    class Program
    {
        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            try
            {
                ...
                int i = 0; // Pointer for the current position to insert unique element
                ...
                // The length of unique elements array is i+1
                return i + 1;
            }
            catch (Exception)
            {
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                int index = 0; // Initialze index to keep track of non-zero elements
                for (int i = 0; i < nums.Length; i++)
                {
                    // When a non-zero element is found, place it at the current index and increment index
                    if (nums[i] != 0)
                    {
                        nums[index++] = nums[i];
                    }
            ...
            try
            {
                ...
                foreach (int num in nums)
                {
                    if (num == 1)
                    {
                        ...
                        maxCount = Math.Max(maxCount, currentCount);  // Update maxCount if current sequence is longer
                    }
                    else
                    {
                        currentCount = 0;  // Reset the count when a zero is encountered
                    }
                }
                return maxCount;
            }
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            try
            {
                // Initialize decimal value and base value
                ...
                while (binary > 0)
                {
                    ...
                    // Convert binary to decimal by multiplying the last digit by the base value and adding to the decimal value
                    decimalValue += lastDigit * baseValue;
                    baseValue = baseValue * 2;  // Increase the base value (powers of 2)
                }
                return decimalValue;
            }
            catch (Exception)
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                // Return 0 if array contains less than two elements, as no gap exists
                if (nums.Length < 2) return 0;

                // Sort the array to find the maximum gap between successive elements
                Array.Sort(nums);
                int maxGap = 0;
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                ...
                {
                    // Remove the first occurrence of part from s
                    s = s.Replace(part, "");
                }
                return s;
            }
